...
//��������IMU_Init(void)
//��������̬�����ںϳ�ʼ������
//����ʹ���������㣬����ʹ��MPU6050��Ӳ�����㵥ԪDMP��IMU_SW��SysConfig.h�ж���
void IMU_Init(void)
{
    imu.ready = 1;
    imu.caliPass = 1;
...
//  MAG_Yaw+=1.27f;//�ɶ��ش�ƫ��Ϊ1.27��
//  //MAG_Yaw/=57.3f;/so3_comp_params_Ki/ת�ɻ����ƣ�
...
//            acc_offsets_sum[0] = 0;								//accoffset��0�Ƚ����ף���0�Ļ����ر��ȡ�����Ҫoffset
//            acc_offsets_sum[1]  =  0  ;
//            acc_offsets_sum[2]  =   0  ;
